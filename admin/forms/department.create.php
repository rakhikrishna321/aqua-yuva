...
<form action="/admin/actions/department.create.php" id="department_create" method="POST" autocomplete="off">
    <div class="modal-body" style="max-height: 70vh;overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-md-12 mt-3">
                ...
                <input type="text" name="handled_by" class="form-control form-control-lg" required>
            </div>
            <div class="form-group col-md-12 mt-3">
